...
import io.github.xrickastley.originsmath.mixins.HudRenderAccessor;
...
public final class OriginsMathHudRender extends HudRender {
    ...
    public int compareTo(@NotNull HudRender other) {
		...
		return orderResult != 0 
			? orderResult 
			: ((HudRenderAccessor)(Object) this).getSpriteLocation().compareTo(((HudRenderAccessor)(Object) other).getSpriteLocation());
    }
    ...
    public void send(PacketByteBuf buffer) {
        ...
        OriginsMathHudRender.MULTIPLE_DATA_TYPE.send(buffer, ((HudRenderAccessor)(Object) this).getChildren());
    }
