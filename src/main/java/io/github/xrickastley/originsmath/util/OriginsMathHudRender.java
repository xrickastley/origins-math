...
public final class OriginsMathHudRender extends HudRender {
    public static final OriginsMathHudRender DONT_RENDER = new OriginsMathHudRender(false, ResourceBacked.fromNumber(0), Apoli.identifier("textures/gui/resource_bar.png"), null, false);

	private final ResourceBacked<Integer> barIndex;

	public OriginsMathHudRender(boolean shouldRender, ResourceBacked<Integer> barIndex, Identifier spriteLocation, ConditionFactory<LivingEntity>.Instance condition, boolean inverted) {
		super(shouldRender, -1, spriteLocation, condition, inverted);
